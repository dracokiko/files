 ...
 */
export default function PhilosopherWatermark({
  src,
  name,
  className = '',
  imgClassName = 'w-40 2xl:w-48',
}: PhilosopherWatermarkProps) {
  return (
    <figure
    ...
    >
      <img
        ...
        alt=""
        aria-hidden="true"
        className={`${imgClassName} opacity-[0.18] grayscale contrast-125 brightness-75`}
        draggable={false}
      />
